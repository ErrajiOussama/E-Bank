package com.nassih.bankapi.mappers;
...
import com.nassih.bankapi.entities.AccountOperation;
...
public class BankAccountMapperImpl {
    public CustomerDTO fromCustomer(Customer customer) {
        ...
        BeanUtils.copyProperties(customer, customerDTO); //meilleur solution ===> MapStruck
        //on utilise beanutils a la place de transferer attribut par attribut
        return customerDTO;
    }
